...
import 'mad_fab_item.dart';
import 'animated_fab.dart';
import 'animated_fab_child.dart';
...
class MADFAB extends StatefulWidget {
  ...
  @override
  _MADFABState createState() => _MADFABState();
}
...
class _MADFABState extends State<MADFAB> with SingleTickerProviderStateMixin {
  ...
  Widget _renderButton() {
    ...
    var animatedFloatingButton = AnimatedMadFAB(
